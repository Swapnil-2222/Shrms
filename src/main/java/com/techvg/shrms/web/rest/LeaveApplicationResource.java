...
import com.techvg.shrms.service.LeaveApplicationQueryService;
import com.techvg.shrms.service.LeaveApplicationService;
...
/**
 * REST controller for managing {@link com.techvg.shrms.domain.LeaveApplication}.
 */
@RestController
@RequestMapping("/api")
public class LeaveApplicationResource {
    ...
    public ResponseEntity<LeaveApplicationDTO> createLeaveApplication(@RequestBody LeaveApplicationDTO leaveApplicationDTO)
