...
import com.techvg.shrms.service.PfDetailsQueryService;
import com.techvg.shrms.service.PfDetailsService;
...
/**
 * REST controller for managing {@link com.techvg.shrms.domain.PfDetails}.
 */
@RestController
@RequestMapping("/api")
public class PfDetailsResource {
    ...
    public PfDetailsResource(
        PfDetailsService pfDetailsService,
        PfDetailsRepository pfDetailsRepository,
     ...
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new pfDetailsDTO, or with status {@code 400 (Bad Request)} if the pfDetails has already an ID.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PostMapping("/pf-details")
    public ResponseEntity<PfDetailsDTO> createPfDetails(@RequestBody PfDetailsDTO pfDetailsDTO) throws URISyntaxException {
        ...
        return ResponseEntity
            .created(new URI("/api/pf-details/" + result.getId()))
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated pfDetailsDTO,
     * or with status {@code 400 (Bad Request)} if the pfDetailsDTO is not valid,
     * or with status {@code 500 (Internal Server Error)} if the pfDetailsDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/pf-details/{id}")
    public ResponseEntity<PfDetailsDTO> updatePfDetails(
        @PathVariable(value = "id", required = false) final Long id,
        @RequestBody PfDetailsDTO pfDetailsDTO
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, pfDetailsDTO.getId().toString()))
            .body(result);
    }

    /**
     * {@code PATCH  /pf-details/:id} : Partial updates given fields of an existing pfDetails, field will ignore if it is null
     *
     * @param id the id of the pfDetailsDTO to save.
     * @param pfDetailsDTO the pfDetailsDTO to update.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated pfDetailsDTO,
     * or with status {@code 400 (Bad Request)} if the pfDetailsDTO is not valid,
     * or with status {@code 404 (Not Found)} if the pfDetailsDTO is not found,
     * or with status {@code 500 (Internal Server Error)} if the pfDetailsDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of pfDetails in body.
     */
    @GetMapping("/pf-details")
    public ResponseEntity<List<PfDetailsDTO>> getAllPfDetails(
        PfDetailsCriteria criteria,
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the pfDetailsDTO, or with status {@code 404 (Not Found)}.
     */
