...
import com.techvg.shrms.service.EsiDetailsQueryService;
import com.techvg.shrms.service.EsiDetailsService;
...
/**
 * REST controller for managing {@link com.techvg.shrms.domain.EsiDetails}.
 */
@RestController
@RequestMapping("/api")
public class EsiDetailsResource {
    ...
    public EsiDetailsResource(
        EsiDetailsService esiDetailsService,
        EsiDetailsRepository esiDetailsRepository,
     ...
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new esiDetailsDTO, or with status {@code 400 (Bad Request)} if the esiDetails has already an ID.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PostMapping("/esi-details")
    public ResponseEntity<EsiDetailsDTO> createEsiDetails(@RequestBody EsiDetailsDTO esiDetailsDTO) throws URISyntaxException {
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated esiDetailsDTO,
     * or with status {@code 400 (Bad Request)} if the esiDetailsDTO is not valid,
     * or with status {@code 500 (Internal Server Error)} if the esiDetailsDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/esi-details/{id}")
    public ResponseEntity<EsiDetailsDTO> updateEsiDetails(
        @PathVariable(value = "id", required = false) final Long id,
        @RequestBody EsiDetailsDTO esiDetailsDTO
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, esiDetailsDTO.getId().toString()))
            .body(result);
    }

    /**
     * {@code PATCH  /esi-details/:id} : Partial updates given fields of an existing esiDetails, field will ignore if it is null
     *
     * @param id the id of the esiDetailsDTO to save.
     * @param esiDetailsDTO the esiDetailsDTO to update.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated esiDetailsDTO,
     * or with status {@code 400 (Bad Request)} if the esiDetailsDTO is not valid,
     * or with status {@code 404 (Not Found)} if the esiDetailsDTO is not found,
     * or with status {@code 500 (Internal Server Error)} if the esiDetailsDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    ...
    public ResponseEntity<EsiDetailsDTO> partialUpdateEsiDetails(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, esiDetailsDTO.getId().toString())
        );
    }
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of esiDetails in body.
     */
    @GetMapping("/esi-details")
    public ResponseEntity<List<EsiDetailsDTO>> getAllEsiDetails(
        EsiDetailsCriteria criteria,
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the esiDetailsDTO, or with status {@code 404 (Not Found)}.
     */
