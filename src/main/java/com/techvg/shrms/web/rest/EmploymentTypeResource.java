...
import com.techvg.shrms.repository.EmploymentTypeRepository;
import com.techvg.shrms.service.EmploymentTypeQueryService;
import com.techvg.shrms.service.EmploymentTypeService;
import com.techvg.shrms.service.criteria.EmploymentTypeCriteria;
...
/**
 * REST controller for managing {@link com.techvg.shrms.domain.EmploymentType}.
 */
@RestController
@RequestMapping("/api")
public class EmploymentTypeResource {
    ...
    public ResponseEntity<EmploymentTypeDTO> createEmploymentType(@RequestBody EmploymentTypeDTO employmentTypeDTO)
    ...
    public ResponseEntity<EmploymentTypeDTO> updateEmploymentType(
        ...
        @RequestBody EmploymentTypeDTO employmentTypeDTO
    ) throws URISyntaxException {
        ...
        EmploymentTypeDTO result = employmentTypeService.update(employmentTypeDTO);
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, employmentTypeDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<EmploymentTypeDTO> partialUpdateEmploymentType(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, employmentTypeDTO.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<EmploymentTypeDTO>> getAllEmploymentTypes(
        EmploymentTypeCriteria criteria,
