...
import com.techvg.shrms.service.RemunerationQueryService;
import com.techvg.shrms.service.RemunerationService;
...
/**
 * REST controller for managing {@link com.techvg.shrms.domain.Remuneration}.
 */
@RestController
@RequestMapping("/api")
public class RemunerationResource {
     ...
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new remunerationDTO, or with status {@code 400 (Bad Request)} if the remuneration has already an ID.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PostMapping("/remunerations")
    public ResponseEntity<RemunerationDTO> createRemuneration(@RequestBody RemunerationDTO remunerationDTO) throws URISyntaxException {
        ...
        return ResponseEntity
            .created(new URI("/api/remunerations/" + result.getId()))
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated remunerationDTO,
     * or with status {@code 400 (Bad Request)} if the remunerationDTO is not valid,
     * or with status {@code 500 (Internal Server Error)} if the remunerationDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/remunerations/{id}")
    public ResponseEntity<RemunerationDTO> updateRemuneration(
        @PathVariable(value = "id", required = false) final Long id,
        @RequestBody RemunerationDTO remunerationDTO
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, remunerationDTO.getId().toString()))
            .body(result);
    }

    /**
     * {@code PATCH  /remunerations/:id} : Partial updates given fields of an existing remuneration, field will ignore if it is null
     *
     * @param id the id of the remunerationDTO to save.
     * @param remunerationDTO the remunerationDTO to update.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated remunerationDTO,
     * or with status {@code 400 (Bad Request)} if the remunerationDTO is not valid,
     * or with status {@code 404 (Not Found)} if the remunerationDTO is not found,
     * or with status {@code 500 (Internal Server Error)} if the remunerationDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    ...
    public ResponseEntity<RemunerationDTO> partialUpdateRemuneration(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, remunerationDTO.getId().toString())
        );
    }
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of remunerations in body.
     */
    @GetMapping("/remunerations")
    public ResponseEntity<List<RemunerationDTO>> getAllRemunerations(
        RemunerationCriteria criteria,
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the remunerationDTO, or with status {@code 404 (Not Found)}.
     */
