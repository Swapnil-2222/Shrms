...
import com.techvg.shrms.service.DesignationQueryService;
import com.techvg.shrms.service.DesignationService;
...
/**
 * REST controller for managing {@link com.techvg.shrms.domain.Designation}.
 */
@RestController
@RequestMapping("/api")
public class DesignationResource {
    ...
    public ResponseEntity<DesignationDTO> partialUpdateDesignation(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, designationDTO.getId().toString())
        );
    }
