...
/**
 * Criteria class for the {@link com.techvg.shrms.domain.ApprovalLevel} entity. This class is used
 * in {@link com.techvg.shrms.web.rest.ApprovalLevelResource} to receive all the possible filtering options from
...
public class ApprovalLevelCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, squence, approvalSettingId, companyId, status, lastModified, lastModifiedBy, distinct);
    }
