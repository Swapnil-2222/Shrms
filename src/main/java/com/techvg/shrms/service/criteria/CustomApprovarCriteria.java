...
/**
 * Criteria class for the {@link com.techvg.shrms.domain.CustomApprovar} entity. This class is used
 * in {@link com.techvg.shrms.web.rest.CustomApprovarResource} to receive all the possible filtering options from
...
public class CustomApprovarCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, employeId, approvalSettingId, squence, companyId, status, lastModified, lastModifiedBy, distinct);
    }
