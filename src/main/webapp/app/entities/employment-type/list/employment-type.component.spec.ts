...
describe('EmploymentType Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'employment-type', component: EmploymentTypeComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.employmentTypes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to employmentTypeService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getEmploymentTypeIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getEmploymentTypeIdentifier).toHaveBeenCalledWith(entity);
