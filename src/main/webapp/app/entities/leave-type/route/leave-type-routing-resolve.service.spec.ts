...
describe('LeaveType routing resolve service', () => {
  ...
  let resultLeaveType: ILeaveType | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultLeaveType).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ILeaveType>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
