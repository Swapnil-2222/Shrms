...
describe('LeaveType Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'leave-type', component: LeaveTypeComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to leaveTypeService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getLeaveTypeIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getLeaveTypeIdentifier).toHaveBeenCalledWith(entity);
