...
describe('Holiday Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'holiday', component: HolidayComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to holidayService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getHolidayIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getHolidayIdentifier).toHaveBeenCalledWith(entity);
