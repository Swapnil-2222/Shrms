...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../holiday.test-samples';

import { HolidayService, RestHoliday } from './holiday.service';

const requireRestSample: RestHoliday = {
  ...sampleWithRequiredData,
  holidayDate: sampleWithRequiredData.holidayDate?.toJSON(),
  year: sampleWithRequiredData.year?.toJSON(),
...
describe('Holiday Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Holiday', () => {
      ...
      const holiday = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(holiday).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a Holiday', () => {
      const holiday = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(holiday).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addHolidayToCollectionIfMissing', () => {
      it('should add a Holiday to an empty array', () => {
        const holiday: IHoliday = sampleWithRequiredData;
      ...
      it("should add a Holiday to an array that doesn't contain it", () => {
        const holiday: IHoliday = sampleWithRequiredData;
        const holidayCollection: IHoliday[] = [sampleWithPartialData];
        expectedResult = service.addHolidayToCollectionIfMissing(holidayCollection, holiday);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(holiday);
      });
      ...
      it('should add only unique Holiday to an array', () => {
        const holidayArray: IHoliday[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const holidayCollection: IHoliday[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const holiday: IHoliday = sampleWithRequiredData;
        const holiday2: IHoliday = sampleWithPartialData;
    ...
    describe('compareHoliday', () => {
      it('Should return true if both entities are null', () => {
        const entity1 = null;
        const entity2 = null;

        const compareResult = service.compareHoliday(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareHoliday(entity1, entity2);
        const compareResult2 = service.compareHoliday(entity2, entity1);
