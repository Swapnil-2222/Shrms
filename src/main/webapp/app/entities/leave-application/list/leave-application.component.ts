...
import { EntityArrayResponseType, LeaveApplicationService } from '../service/leave-application.service';
...
export class LeaveApplicationComponent implements OnInit {
  ...
  trackId = (_index: number, item: ILeaveApplication): number => this.leaveApplicationService.getLeaveApplicationIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.leaveApplications = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: ILeaveApplication[] | null): ILeaveApplication[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.leaveApplicationService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
