...
describe('WorkingHours Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'working-hours', component: WorkingHoursComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to workingHoursService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getWorkingHoursIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getWorkingHoursIdentifier).toHaveBeenCalledWith(entity);
