...
class EsiDetailsResourceIT {
    ...
    void getAllEsiDetailsByEmployeIdIsEqualToSomething() throws Exception {
        ...
        // Get all the esiDetailsList where employeId equals to DEFAULT_EMPLOYE_ID
        defaultEsiDetailsShouldBeFound("employeId.equals=" + DEFAULT_EMPLOYE_ID);

        // Get all the esiDetailsList where employeId equals to UPDATED_EMPLOYE_ID
        defaultEsiDetailsShouldNotBeFound("employeId.equals=" + UPDATED_EMPLOYE_ID);
    }

    @Test
    @Transactional
    void getAllEsiDetailsByEmployeIdIsInShouldWork() throws Exception {
        // Initialize the database
        esiDetailsRepository.saveAndFlush(esiDetails);

        // Get all the esiDetailsList where employeId in DEFAULT_EMPLOYE_ID or UPDATED_EMPLOYE_ID
        defaultEsiDetailsShouldBeFound("employeId.in=" + DEFAULT_EMPLOYE_ID + "," + UPDATED_EMPLOYE_ID);

        // Get all the esiDetailsList where employeId equals to UPDATED_EMPLOYE_ID
        defaultEsiDetailsShouldNotBeFound("employeId.in=" + UPDATED_EMPLOYE_ID);
    }

    @Test
    @Transactional
    void getAllEsiDetailsByEmployeIdIsNullOrNotNull() throws Exception {
        // Initialize the database
        esiDetailsRepository.saveAndFlush(esiDetails);

        // Get all the esiDetailsList where employeId is not null
        defaultEsiDetailsShouldBeFound("employeId.specified=true");

        // Get all the esiDetailsList where employeId is null
        defaultEsiDetailsShouldNotBeFound("employeId.specified=false");
    }

    @Test
    @Transactional
    void getAllEsiDetailsByEmployeIdIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        esiDetailsRepository.saveAndFlush(esiDetails);

        // Get all the esiDetailsList where employeId is greater than or equal to DEFAULT_EMPLOYE_ID
        defaultEsiDetailsShouldBeFound("employeId.greaterThanOrEqual=" + DEFAULT_EMPLOYE_ID);

        // Get all the esiDetailsList where employeId is greater than or equal to UPDATED_EMPLOYE_ID
        defaultEsiDetailsShouldNotBeFound("employeId.greaterThanOrEqual=" + UPDATED_EMPLOYE_ID);
    }

    @Test
    @Transactional
    void getAllEsiDetailsByEmployeIdIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        esiDetailsRepository.saveAndFlush(esiDetails);

        // Get all the esiDetailsList where employeId is less than or equal to DEFAULT_EMPLOYE_ID
        defaultEsiDetailsShouldBeFound("employeId.lessThanOrEqual=" + DEFAULT_EMPLOYE_ID);

        // Get all the esiDetailsList where employeId is less than or equal to SMALLER_EMPLOYE_ID
        defaultEsiDetailsShouldNotBeFound("employeId.lessThanOrEqual=" + SMALLER_EMPLOYE_ID);
    }

    @Test
    @Transactional
    void getAllEsiDetailsByEmployeIdIsLessThanSomething() throws Exception {
        // Initialize the database
        esiDetailsRepository.saveAndFlush(esiDetails);

        // Get all the esiDetailsList where employeId is less than DEFAULT_EMPLOYE_ID
        defaultEsiDetailsShouldNotBeFound("employeId.lessThan=" + DEFAULT_EMPLOYE_ID);

        // Get all the esiDetailsList where employeId is less than UPDATED_EMPLOYE_ID
        defaultEsiDetailsShouldBeFound("employeId.lessThan=" + UPDATED_EMPLOYE_ID);
    }

    @Test
    @Transactional
    void getAllEsiDetailsByEmployeIdIsGreaterThanSomething() throws Exception {
        // Initialize the database
        esiDetailsRepository.saveAndFlush(esiDetails);

        // Get all the esiDetailsList where employeId is greater than DEFAULT_EMPLOYE_ID
        defaultEsiDetailsShouldNotBeFound("employeId.greaterThan=" + DEFAULT_EMPLOYE_ID);

        // Get all the esiDetailsList where employeId is greater than SMALLER_EMPLOYE_ID
        defaultEsiDetailsShouldBeFound("employeId.greaterThan=" + SMALLER_EMPLOYE_ID);
    }
    ...
    void deleteEsiDetails() throws Exception {
        ...
        restEsiDetailsMockMvc
            .perform(delete(ENTITY_API_URL_ID, esiDetails.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON))
