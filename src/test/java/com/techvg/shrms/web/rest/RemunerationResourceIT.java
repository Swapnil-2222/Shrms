...
class RemunerationResourceIT {
    ...
    void createRemuneration() throws Exception {
        ...
        assertThat(testRemuneration.getEmployeId()).isEqualTo(DEFAULT_EMPLOYE_ID);
    ...
    @Test
    @Transactional
    void getAllRemunerationsByEmployeIdIsEqualToSomething() throws Exception {
        // Initialize the database
        remunerationRepository.saveAndFlush(remuneration);

        // Get all the remunerationList where employeId equals to DEFAULT_EMPLOYE_ID
        defaultRemunerationShouldBeFound("employeId.equals=" + DEFAULT_EMPLOYE_ID);

        // Get all the remunerationList where employeId equals to UPDATED_EMPLOYE_ID
        defaultRemunerationShouldNotBeFound("employeId.equals=" + UPDATED_EMPLOYE_ID);
    }

    @Test
    @Transactional
    void getAllRemunerationsByEmployeIdIsInShouldWork() throws Exception {
        // Initialize the database
        remunerationRepository.saveAndFlush(remuneration);

        // Get all the remunerationList where employeId in DEFAULT_EMPLOYE_ID or UPDATED_EMPLOYE_ID
        defaultRemunerationShouldBeFound("employeId.in=" + DEFAULT_EMPLOYE_ID + "," + UPDATED_EMPLOYE_ID);

        // Get all the remunerationList where employeId equals to UPDATED_EMPLOYE_ID
        defaultRemunerationShouldNotBeFound("employeId.in=" + UPDATED_EMPLOYE_ID);
    }

    @Test
    @Transactional
    void getAllRemunerationsByEmployeIdIsNullOrNotNull() throws Exception {
        // Initialize the database
        remunerationRepository.saveAndFlush(remuneration);

        // Get all the remunerationList where employeId is not null
        defaultRemunerationShouldBeFound("employeId.specified=true");

        // Get all the remunerationList where employeId is null
        defaultRemunerationShouldNotBeFound("employeId.specified=false");
    }

    @Test
    @Transactional
    void getAllRemunerationsByEmployeIdIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        remunerationRepository.saveAndFlush(remuneration);

        // Get all the remunerationList where employeId is greater than or equal to DEFAULT_EMPLOYE_ID
        defaultRemunerationShouldBeFound("employeId.greaterThanOrEqual=" + DEFAULT_EMPLOYE_ID);

        // Get all the remunerationList where employeId is greater than or equal to UPDATED_EMPLOYE_ID
        defaultRemunerationShouldNotBeFound("employeId.greaterThanOrEqual=" + UPDATED_EMPLOYE_ID);
    }

    @Test
    @Transactional
    void getAllRemunerationsByEmployeIdIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        remunerationRepository.saveAndFlush(remuneration);

        // Get all the remunerationList where employeId is less than or equal to DEFAULT_EMPLOYE_ID
        defaultRemunerationShouldBeFound("employeId.lessThanOrEqual=" + DEFAULT_EMPLOYE_ID);

        // Get all the remunerationList where employeId is less than or equal to SMALLER_EMPLOYE_ID
        defaultRemunerationShouldNotBeFound("employeId.lessThanOrEqual=" + SMALLER_EMPLOYE_ID);
    }

    @Test
    @Transactional
    void getAllRemunerationsByEmployeIdIsLessThanSomething() throws Exception {
        // Initialize the database
        remunerationRepository.saveAndFlush(remuneration);

        // Get all the remunerationList where employeId is less than DEFAULT_EMPLOYE_ID
        defaultRemunerationShouldNotBeFound("employeId.lessThan=" + DEFAULT_EMPLOYE_ID);

        // Get all the remunerationList where employeId is less than UPDATED_EMPLOYE_ID
        defaultRemunerationShouldBeFound("employeId.lessThan=" + UPDATED_EMPLOYE_ID);
    }

    @Test
    @Transactional
    void getAllRemunerationsByEmployeIdIsGreaterThanSomething() throws Exception {
        // Initialize the database
        remunerationRepository.saveAndFlush(remuneration);

        // Get all the remunerationList where employeId is greater than DEFAULT_EMPLOYE_ID
        defaultRemunerationShouldNotBeFound("employeId.greaterThan=" + DEFAULT_EMPLOYE_ID);

        // Get all the remunerationList where employeId is greater than SMALLER_EMPLOYE_ID
        defaultRemunerationShouldBeFound("employeId.greaterThan=" + SMALLER_EMPLOYE_ID);
    }
    ...
    void putExistingRemuneration() throws Exception {
        ...
        assertThat(testRemuneration.getEmployeId()).isEqualTo(UPDATED_EMPLOYE_ID);
    ...
    void deleteRemuneration() throws Exception {
        ...
        restRemunerationMockMvc
            .perform(delete(ENTITY_API_URL_ID, remuneration.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON))
