...
import com.techvg.shrms.service.mapper.CustomApprovarMapper;
...
class CustomApprovarResourceIT {
    ...
    void deleteCustomApprovar() throws Exception {
        ...
        restCustomApprovarMockMvc
            .perform(delete(ENTITY_API_URL_ID, customApprovar.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON))
