...
import com.techvg.shrms.service.mapper.ApprovalSettingMapper;
...
class ApprovalSettingResourceIT {
    ...
    void deleteApprovalSetting() throws Exception {
        ...
        restApprovalSettingMockMvc
            .perform(delete(ENTITY_API_URL_ID, approvalSetting.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON))
