...
import com.techvg.shrms.service.mapper.EmploymentTypeMapper;
...
class EmploymentTypeResourceIT {
    ...
    void deleteEmploymentType() throws Exception {
        ...
        restEmploymentTypeMockMvc
            .perform(delete(ENTITY_API_URL_ID, employmentType.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON))
