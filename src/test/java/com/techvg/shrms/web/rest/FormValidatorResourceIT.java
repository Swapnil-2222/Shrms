...
import com.techvg.shrms.service.mapper.FormValidatorMapper;
...
class FormValidatorResourceIT {
    ...
    void deleteFormValidator() throws Exception {
        ...
        restFormValidatorMockMvc
            .perform(delete(ENTITY_API_URL_ID, formValidator.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON))
