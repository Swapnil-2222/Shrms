...
import com.techvg.shrms.service.mapper.PersonalDetailsMapper;
...
class PersonalDetailsResourceIT {
    ...
    void deletePersonalDetails() throws Exception {
        ...
        restPersonalDetailsMockMvc
            .perform(delete(ENTITY_API_URL_ID, personalDetails.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON))
