...
import com.techvg.shrms.service.mapper.MasterLookupMapper;
...
class MasterLookupResourceIT {
    ...
    void deleteMasterLookup() throws Exception {
        ...
        restMasterLookupMockMvc
            .perform(delete(ENTITY_API_URL_ID, masterLookup.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON))
